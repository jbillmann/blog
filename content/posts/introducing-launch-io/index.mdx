...
So, that is why I, with help and ideas from [Andrew Petersen](https://www.dev.to/droopytersen), created [Launch.IO](https://www.launchio.dev); an ultra hip, simple, smart, and fast, React state management library. I think that great libraries should be fun and rewarding to developers, and so I added [time travel debugging](https://en.wikipedia.org/wiki/Time_travel_debugging).

I am not going to get into `code` in this blog post, so feel free to pause for one minute, and grok the [Launch.IO website](https://www.launchio.dev) or go straight to the [CodeSandbox Demo](https://codesandbox.io/s/launchio-demo-yqo2n). The website is one simple page and it covers install, setup, and basic use cases. If you are enjoying what you are reading, you can take an extra 5 minutes and read _all_ of the [Launch.IO API documentation](https://github.com/launch-io/launch.io/blob/master/docs/api/index.md).
